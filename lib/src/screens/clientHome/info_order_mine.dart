...
// import 'package:kargo_app/src/screens/initial/providers/orders_byid_provider.dart';
...
//     final orderById = widget.orderInfo;
//     int t = 0;
//     final int l = orderById.ordersById?.points.length ?? 0;
...
//                               padding: const EdgeInsets.only(left: 5),
//                               child: Text(
//                                 orderById.ordersById?.summaryCube.toString() ?? '',
//                                 style: TextStyle(
//                                   color: Colors.black,
//                                   fontSize: deviceWidth / 26,
//                                   fontFamily: 'Roboto',
...
//                             ),
//                             Text(
//                               orderById.ordersById?.summaryPrice.toString() ?? '',
//                               style: TextStyle(
//                                 color: Colors.black,
//                                 fontSize: deviceWidth / 26,
//                                 fontFamily: 'Roboto',
...
//                         children: [
//                           Text(
//                             orderById.ordersById?.danhaoCode.toString() ?? '',
//                             style: TextStyle(
//                               color: Colors.black,
//                               fontSize: deviceWidth / 26,
//                               fontFamily: 'Roboto',
...
//                               // ),
//                               Text(
//                                 orderById.ordersById?.trackCode.toString() ?? '',
//                                 style: TextStyle(
//                                   color: Colors.black,
//                                   fontSize: deviceWidth / 26,
//                                   fontFamily: 'Roboto',
...
//                                             orderById.ordersById!.images[index],
//                                           ),
...
//                                   width: 100,
//                                   child: Image.network(
//                                     orderById.ordersById!.images[indexx],
//                                     fit: BoxFit.cover,
//                                     loadingBuilder: (
//                                       BuildContext context,
//                                       Widget child,
...
//                               id: int.parse(widget.orderInfo.id.toString()),
//                             ),
//                           ),
//                         );
//                       },
