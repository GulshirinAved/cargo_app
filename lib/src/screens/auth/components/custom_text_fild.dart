...
class CustomTextFildWithText extends StatelessWidget {
  ...
  String text;
  TextEditingController controller;
  CustomTextFildWithText({required this.hint, required this.text, required this.controller, super.key});
  ...
  search(value) async {
    if (widget.tickedID.isEmpty) {
      ...
      if (controller.text.isNotEmpty && controller1.text.isNotEmpty) {
        ...
        showSnackBar('Ýalňyşlyk', 'Ulag No dolduruň', Colors.red);
      }
    }
  }
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    InkWell(
                      onTap: () async {
                        final String userID = clientHomeController.userId.value;
                        if (widget.tickedID == '') {
                          showSnackBar('Ýalňyşlyk', 'ID saýlaň', Colors.red);
                        } else {
                          if (controller.text.isNotEmpty && controller1.text.isNotEmpty) {
